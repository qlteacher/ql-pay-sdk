...
public class WXPayUtil {
    ...
    public static String generateSignedXml(final Map<String, String> data, String key, SignType signType)
        ...
        data.put(QLWXPayConstants.FIELD_SIGN, sign);
    ...
    public static boolean isSignatureValid(String xmlStr, String key) throws Exception {
        ...
        if (!data.containsKey(QLWXPayConstants.FIELD_SIGN)) {
            return false;
        }
        String sign = data.get(QLWXPayConstants.FIELD_SIGN);
    ...
    public static String generateSignature(final Map<String, String> data, String key, SignType signType)
        ...
        for (String k : keyArray) {
            if (k.equals(QLWXPayConstants.FIELD_SIGN)) {
                continue;
            }
    ...
    public static Map<String,String> wxInfoDecrypt(String keyStr, String content) throws Exception {
        Security.addProvider(new BouncyCastleProvider());
        byte[] bt = Base64.decodeBase64(content);
        String md5key = MD5(keyStr).toLowerCase();
        SecretKey secretKey = new SecretKeySpec(md5key.getBytes(), "AES");
        Cipher cipher = Cipher.getInstance("AES/ECB/PKCS7Padding", "BC");
        cipher.init(Cipher.DECRYPT_MODE, secretKey);
        byte[] resultbt = cipher.doFinal(bt);
        return xmlToMap(new String(resultbt,"UTF-8"));
    }
